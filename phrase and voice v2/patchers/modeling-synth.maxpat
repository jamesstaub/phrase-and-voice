...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 219.0, 32.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 108.333333333333258, 189.5, 36.0, 22.0 ],
									"text" : "> 0.3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 250.5, 70.5, 22.0 ],
									"text" : "pack f f f f"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.000020333333282, 332.5, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 136.5, 56.5, 145.0, 22.0 ],
...
,
					"text" : "p filter-pitch-by-periodicity"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 709.0, 489.0, 38.0, 22.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 156.25, 603.5, 29.5, 22.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 22.0, 397.0, 38.0, 22.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 481.75, 763.0, 49.0, 22.0 ],
					"text" : "target 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 468.75, 728.5, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.0, 9.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 468.75, 701.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1057.0, 557.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 973.5, 479.0, 92.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 973.5, 401.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 973.5, 439.0, 79.0, 22.0 ],
					"text" : "prepend filter"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1089.5, 439.0, 131.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 304.0, 64.0, 129.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1089.5, 404.0, 127.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 304.0, 41.0, 239.0, 16.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
...
,
					...
					"texton" : "match frequency",
					"varname" : "#0-model-frequency"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 731.5, 818.0, 127.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 304.0, 3.199982000000091, 239.0, 26.0 ],
					"text" : "granular"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 242.0, 685.5, 92.0, 22.0 ],
					"text" : "prepend control"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 242.0, 627.5, 29.5, 22.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.5, 655.5, 53.0, 23.0 ],
					"text" : "target 0"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 830.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 150.0, 640.5, 22.418803334236145, 22.418803334236145 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 182.0, 639.5, 131.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 315.0, 637.5, 112.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 82.0, 640.5, 65.0, 22.0 ],
									"text" : "reverse $1",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 464.0, 764.5, 189.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 647.0, 762.5, 299.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 464.0, 733.5, 164.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 622.0, 731.5, 286.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 464.0, 702.5, 217.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 675.0, 700.5, 228.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 464.0, 671.5, 243.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 701.0, 670.5, 172.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 366.0, 734.5, 85.0, 22.0 ],
									"text" : "loadmess 100"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 213.0, 765.5, 250.0, 18.0 ],
									"size" : 10.0
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 150.0, 764.5, 60.0, 22.0 ],
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
									"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 213.0, 734.5, 250.0, 18.0 ],
									"size" : 120.0
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 150.0, 733.5, 60.0, 22.0 ],
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
									"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 213.0, 703.5, 250.0, 18.0 ],
									"size" : 1201.0
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 150.0, 702.5, 60.0, 22.0 ],
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
									"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 44.0, 702.5, 103.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 78.0, 764.5, 69.0, 22.0 ],
									"text" : "levelvar $1",
									"textcolor" : [ 0.92, 0.92, 0.92, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 366.0, 672.5, 92.0, 22.0 ],
									"text" : "loadmess 1200"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 213.0, 672.5, 250.0, 18.0 ],
									"size" : 2401.0
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 150.0, 671.5, 60.0, 22.0 ],
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
									"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 61.0, 671.5, 86.0, 22.0 ],
									"text" : "resampling $1",
									"textcolor" : [ 0.92, 0.92, 0.92, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 95.0, 734.5, 52.0, 22.0 ],
									"text" : "level $1",
									"textcolor" : [ 0.92, 0.92, 0.92, 1.0 ]
								}
...
,
					"patching_rect" : [ 242.0, 600.0, 113.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 141.0, 90.5, 113.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 983.5, 622.5, 49.0, 22.0 ],
					"text" : "target 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 973.0, 591.0, 29.5, 22.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					"comment" : "granular global settings",
					"id" : "obj-35",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.5, 9.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1248.0, 740.0, 186.0, 23.0 ],
					"text" : "target 0, control periodvar $1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1248.0, 667.0, 211.0, 23.0 ],
					"text" : "target $1, control periodvar 0 0.125"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.5, 36.0, 70.0, 22.0 ],
					"text" : "loadmess 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1243.0, 476.5, 95.0, 21.0 ],
					"text" : "transpose",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 540.0, 9.0, 68.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 249.5, 119.5, 68.0, 21.0 ],
					"text" : "poly voices"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 540.0, 36.0, 51.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 258.5, 140.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 728.0, 426.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1248.0, 703.0, 194.0, 23.0 ],
					"text" : "target 0, control positionvar $1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1057.0, 622.5, 175.0, 23.0 ],
					"text" : "target $1, control period $2 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 1057.0, 590.5, 72.0, 23.0 ],
					"text" : "listfunnel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1248.0, 568.5, 169.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1243.0, 435.0, 173.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1248.0, 499.5, 245.0, 56.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1248.0, 623.5, 220.0, 23.0 ],
					"text" : "target $1, control resample_steps $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 1248.0, 591.5, 72.0, 23.0 ],
					"text" : "listfunnel 1"
				}
...
, 			{
				"box" : 				{
					"comment" : "concat global settings",
					"id" : "obj-24",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 728.0, 456.0, 79.0, 22.0 ],
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 731.5, 763.0, 370.0, 75.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 284.0, 170.5, 266.0, 75.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 731.5, 728.5, 264.0, 22.0 ],
					"text" : "mc.poly~ poly-granular 4 @args #1  #2         "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.75, 641.5, 49.0, 22.0 ],
					"text" : "target 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 688.0, 41.5, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 242.0, 371.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 358.0, 374.0, 169.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 129.0, 60.0, 151.0, 16.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
...
,
					"text" : "match duration",
					"texton" : "match duration",
					"varname" : "#0-model-timing[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 242.0, 477.0, 92.0, 22.0 ],
					"text" : "prepend control"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 242.0, 451.0, 89.0, 22.0 ],
					"text" : "prepend legato"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 242.0, 292.0, 109.0, 22.0 ],
					"text" : "prepend transpose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 242.0, 332.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 242.0, 413.0, 79.0, 22.0 ],
					"text" : "prepend filter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "", "bang" ],
					"patching_rect" : [ 61.0, 332.0, 40.0, 22.0 ],
					"text" : "t b l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.5, 220.0, 89.0, 22.0 ],
					"text" : "prepend onseg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 136.5, 91.0, 71.0, 22.0 ],
					"text" : "prepend yin"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 358.0, 413.0, 152.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 65.0, 129.0, 16.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"#0-model-frequency[2]" : [ 0.0 ],
						"#0-model-frequency[3]" : [ 0.0 ],
						"#0-model-timing" : [ 0.0 ],
						"concatenative synth" : [ -3.143332183078726 ],
						"live.dial" : [ 4.0 ]
					}
,
					"text" : "autopattr",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1238.0, 79.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1238.0, 106.0, 177.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1238.0, 136.0, 135.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.5, 844.0, 127.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 3.199982000000091, 239.0, 26.0 ],
					"text" : "concatenative"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 836.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 358.0, 451.0, 146.0, 69.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -6.0, 90.5, 145.0, 69.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "retrigger factor",
							"parameter_mmax" : 64.0,
							"parameter_shortname" : "legato retrigger factor",
							"parameter_type" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 358.0, 335.0, 169.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 129.0, 37.0, 151.0, 16.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
...
,
					"text" : "match timing and level",
					"texton" : "match timing and level",
					"varname" : "#0-model-timing"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 358.0, 295.0, 169.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 37.0, 239.0, 16.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 136.5, 13.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1215.0, 186.0, 288.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 18.0, 763.0, 386.0, 75.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 170.5, 266.0, 75.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ -12 ],
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1215.0, 264.0, 326.5, 100.0 ],
					"text" : "TODO:\nthe rhythmic GMM mubu buffer could be used as a temporal model for timings and dynamics\n\nalso create an algorithm that takes NoteName + Chroma + Harmonicity and derives a harmony to trigger chords to the polyconcat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 265.0, 91.0, 22.0 ],
					"text" : "prepend concat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 299.0, 79.0, 22.0 ],
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 18.0, 728.5, 284.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2392.0, 384.5, 333.0, 141.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-27" : [ "granular", "granular", 0 ],
			"obj-28" : [ "multislider[1]", "multislider[1]", 0 ],
			"obj-4" : [ "live.text[3]", "live.text", 0 ],
			"obj-71" : [ "concatenative synth", "concatenative synth", 0 ],
			"obj-92" : [ "live.text[15]", "live.text", 0 ],
